...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Fluid-seeder\n"
...
static const string mainnet_seeds[] = {"seed1.fluidchains.net", "seed2.fluidchains.cloud", "seed3.fluidchains.net", "seed4.fluidchains.cloud", ""};
static const string testnet_seeds[] = {"testnode1.fluidchains.net", "testnode2.fluidchains.cloud", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("vps101.fluidchains.net", 39391), true);
    db.Add(CService("vps102.fluidchains.cloud", 39391), true);
    db.Add(CService("vps103.fluidchains.net", 39391), true);
    db.Add(CService("vps104.fluidchains.cloud", 39391), true);
  } else {
    db.Add(CService("vpstestnet1.fluidchains.com", 29391), true);
    db.Add(CService("vpstestnet2.fluidchains.cloud", 29391), true);
  }
  do {
